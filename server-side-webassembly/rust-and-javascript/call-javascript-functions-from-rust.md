...
* Node.js apps call Rust functions running in WebAssembly \(e.g., from the SSVM\). [Check out how](pass-any-argument-and-return-any-value.md).
* The Rust function occasionally needs to access system resources such as the current time, the standard output console, the file system, and / or the network.
